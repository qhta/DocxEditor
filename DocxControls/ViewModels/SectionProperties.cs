...
public class SectionProperties : ElementViewModel, DA.SectionProperties
{
  ...
  DA.SectionPropertiesChanges DA.SectionProperties.SectionPropertiesChanges => SectionPropertiesChanges;

  /// <summary>
  ///  Collection of headers in this section.
  /// </summary>
  public SectionPropertiesChanges SectionPropertiesChanges
  {
    get
    {
      if (_SectionPropertiesChanges == null)
      {
        _SectionPropertiesChanges = new SectionPropertiesChanges(this);
      }
      return _SectionPropertiesChanges;
    }
  }
